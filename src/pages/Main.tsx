          ...
          <SwiperSlide>
            <div className="flex flex-col-reverse justify-start items-center lg:flex-row lg:justify-center lg:items-end min-w-[100vw] px-[30px]">
              ...
              <img
                ...
                className="w-[250px] sm:w-[300px] md:w-[350px] lg:w-[400px] xl:w-[450px] h-[250px] sm:h-[300px] md:h-[350px] lg:h-[400px] xl:h-[450px] mr-[32px] sm:mr-[40px] md:mr-[48px] lg:mr-[56px] xl:mr-[64px] cursor-pointer"
              />
              <div className="flex flex-col justify-end items-start w-[200px] sm:w-[300px] md:w-[400px] lg:w-[500px] xl:w-[600px] mt-[24px] lg:mt-0">
                <div
